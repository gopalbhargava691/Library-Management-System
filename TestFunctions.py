...
print(member2)
member1.viewBooks()
member1.searchByname('Thermodynamics')
member1.searchByname('Machine Design')
member1.searchByAuthor('P.K. Nag')
member1.searchByAuthor('R.S. Khurmi')
member1.searchByPublishDate('June 1989')
member1.searchByPublishDate('February 1990')
member1.searchByPages('1279')
member1.searchByPages('2087')
